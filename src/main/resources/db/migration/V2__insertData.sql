...
-- USERS TABLE --
INSERT INTO public.users(password, username) VALUES ('$2a$10$DgtQ/lChSYbtPfMxofKXxeCN6Bnrvz6ILXU2jtjTLBjj370DBYm4y', 'admin');           -- USERS_ID 1      -- PASSWORD = 'admin123'
INSERT INTO public.users(password, username) VALUES ('$2a$10$9c9iiVRn6gLaoi5rJFS6MezLeIpQjyyWsqsG6/OnPpnlL6rgSOvsa', 'sawicki');  -- USERS_ID 2      -- PASSWORD = 'sawicki'
INSERT INTO public.users(password, username) VALUES ('$2a$10$zOutCPSe9TX0J6N5rpiO0e9Gg8PYvQzA4wv0UEENMFkbpkUVWLy5G', 'drabik');    -- USERS_ID 3      -- PASSWORD = 'drabik'
...
INSERT INTO public.users(password, username) VALUES ('$2a$10$rEis8WZsMLzw6Vj8s7NJHu./Pgz03tMdaGX2F3.6cDYjaJSq3lVW.', 'marcel');         -- USERS_ID 5      -- PASSWORD = '12345678'
